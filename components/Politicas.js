      ...
      <main className="flex-1 px-4 py-8 sm:px-16 lg:px-32 lg:py-16 xl:px-42 max-w-screen-lg mx-auto">
        <article className="mt-28">
          <div className="leading-8">
            <h1 className="text-2xl text-center">Politicas de privacidad</h1>
            <br />
            <p>
              El presente Política de Privacidad establece los términos en que
              Sarpin usa y protege la información que es proporcionada por sus
            ...
            <br />
            <p>
              Sarpin está altamente comprometido para cumplir con el compromiso
            ...
            <br />
            <h2 className="text-2xl text-center">Cookies</h2>
            <br />
            <p>
            ...
            <h2 className="text-2xl text-center">Enlaces a Terceros</h2>
            <br />
            <p>
            ...
            <p>
              Sarpin Se reserva el derecho de cambiar los términos de la
