...
export default function Terminos() {
  return (
    <>
      <main className="flex-1 px-4 py-8 sm:px-16 lg:px-32 lg:py-16 xl:px-42 max-w-screen-lg mx-auto">
        <article className="mt-28">
          <div className="leading-8">
            <h1 className="text-2xl text-center">Terminos y condiciones</h1>
            <br />
            <p>
            ...
            <p>
              ...
              nuestros productos. sarpin.co no asume la responsabilidad en caso
            ...
            <br />
            <h2 className="text-2xl">LICENCIA</h2>
            <p>
              SARPIN a través de su sitio web concede una licencia para que los
            ...
            <br />
            <h2 className="text-2xl">USO NO AUTORIZADO</h2>
            <p>
            ...
            <br />
            <h2 className="text-2xl">PROPIEDAD</h2>
            ...
            <br />
            <h2 className="text-2xl">POLÍTICA DE REEMBOLSO Y GARANTÍA</h2>
            <p className="leading-8">
            ...
            <br />
            <h2 className="text-2xl">COMPROBACIÓN ANTIFRAUDE</h2>
            <p className="leading-8">
            ...
            <br />
            <h2 className="text-2xl">PRIVACIDAD</h2>
            <p className="leading-8">
              Este sarpin.co garantiza que la información personal que usted
            ...
            <br />
            <p className="leading-8">
              SARPIN reserva los derechos de cambiar o de modificar estos
